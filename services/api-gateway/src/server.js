...
app.use('/api/admin/publish-targets', learningLimiter, gatewayAuth, proxyAiService)
app.use('/api/admin/publish-content', learningLimiter, gatewayAuth, proxyAiService)
