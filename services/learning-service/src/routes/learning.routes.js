...
const { getOverview, completeLesson, joinClass, listStudentClasses, listStudentClassLessons } = require('../controllers/progress.controller')
...
router.post('/progress/join-class', featureFlagGuard('progress'), requireGatewayUser, joinClass)
router.get('/progress/classes', featureFlagGuard('progress'), requireGatewayUser, listStudentClasses)
router.get('/progress/classes/:classId/lessons', featureFlagGuard('progress'), requireGatewayUser, listStudentClassLessons)
...
router.get('/favorites/lessons', featureFlagGuard('favorites'), requireGatewayUser, listLessonFavorites)
router.post('/favorites/lessons/:lessonId/toggle', featureFlagGuard('favorites'), requireGatewayUser, toggleLessonFavorite)
