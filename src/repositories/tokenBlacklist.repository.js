...
class TokenBlacklistRepository {
  ...
  async revokeToken({ token, userId = null, expiresAt }) {
    ...
    await this.pool.query(
      `INSERT INTO token_blacklist (token_hash, token_jti, user_id, expires_at, revoked_at)
       VALUES (?, ?, ?, ?, NOW())
       ON DUPLICATE KEY UPDATE
         ...
         revoked_at = NOW()`,
      [tokenHash, tokenHash, userId, normalizedExpiresAt]
    )
  }
